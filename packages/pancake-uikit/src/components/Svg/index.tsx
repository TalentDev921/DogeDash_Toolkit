...
export { default as LogoNewIcon } from './Icons/LogoNew';
export { default as LogoWithTextNewIcon } from "./Icons/LogoWithTextNew";
export { default as LogoWithTextNew1Icon } from "./Icons/LogoWithTextNew1";
export { default as PancakeRoundNewIcon } from "./Icons/PancakeRoundNew";
